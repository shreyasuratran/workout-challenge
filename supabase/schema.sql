...
create policy "Anyone can update weekly goals"
  ...
  to anon
  using (true)
  with check (weekly_goal between 1 and 7);
...
insert into public.profiles (id, name, weekly_goal)
values
  ('11111111-1111-4111-8111-111111111111', 'Shreya', 4),
  ('22222222-2222-4222-8222-222222222222', 'Aditi', 4),
  ('33333333-3333-4333-8333-333333333333', 'Thaanvi', 4)
